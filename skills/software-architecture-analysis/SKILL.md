...
- [references/interface-extraction-pattern.md](references/interface-extraction-pattern.md) - 阶段 3b 接口提取模式的完整示例，使用在 GitHub 公开并采用 MIT 许可证的 cashew 思维图库。为具有可替换存储后端的代码库设计提供者抽象或 DAO 契约时阅读。
