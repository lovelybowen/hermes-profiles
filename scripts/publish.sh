...
declare -A REMOTES=(
  [backend-engineer]="git@github.com:lovelybowen/backend-engineer-agent.git"
  [debugger]="git@github.com:lovelybowen/debugger-agent.git"
  [frontend-engineer]="git@github.com:lovelybowen/frontend-engineer-agent.git"
  [orchestrator]="git@github.com:lovelybowen/orchestrator-agent.git"
  [qa-engineer]="git@github.com:lovelybowen/qa-engineer-agent.git"
  [researcher]="git@github.com:lovelybowen/researcher-agent.git"
  [reviewer]="git@github.com:lovelybowen/reviewer-agent.git"
  [technical-architect]="git@github.com:lovelybowen/technical-architect-agent.git"
)
